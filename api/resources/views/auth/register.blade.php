...
<html lang="en">
  ...
  <head>
    ...
    <title>MMPG Store | Register</title>
    ...
    <link rel="stylesheet" href="{{ asset('logo/stylesregister.css')}}" />
    ...
    <div class="register-box">
      ...
      <div class="card card-outline card-primary">
        <div class="card-header">
          ...
          <img src="{{ asset('logo/logoMMPG.jpg') }}" alt="Logo" style="width: 75%; height: 75%; display: block; margin: auto;">
            {{-- <h1 class="mb-0"><b>MMPG</b>Store</h1> --}}
          </a>
        </div>
        <div class="card-body register-card-body">
          <p class="register-box-msg">Registro</p>
          <form action="../index3.html" method="post">
            <div class="input-group mb-1">
              <div class="form-floating">
                <input id="registerFullName" type="text" class="form-control" placeholder="" />
                <label for="registerFullName">Nombre</label>
              </div>
          ...
          <!-- /.social-auth-links -->
          <p class="mb-0">
            <a href="/login" class="link-primary text-center"> Ya soy miembro </a>
          </p>
        </div>
        <!-- /.register-card-body -->
      </div>
