...
<div class="d-flex justify-content-between">
    ...
    <form action="{{ url('/admin/discounts/add') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="form-group my-4">
            ...
            <input name="key" value="{{ old('key') }}" type="text" class="form-control" placeholder="Llave del Descuento">
        </div>

        <div class="form-group my-4">
            <label for="">Cantidad:</label>
            <input name="quantity" value="{{ old('quantity') }}" type="number" class="form-control" placeholder="Cantidad">
        </div>

        <div class="form-group my-4">
            <label for="">Venta:</label>
            <input name="sale_id" type="number" class="form-control" placeholder="Venta">
        </div>
